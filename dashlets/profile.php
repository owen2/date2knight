...
<form action="update-profile.php" method="post">
    <p>My name is <?php echo($firstName." ".$lastName);?> and I am a <select name="gender">  <option value ="10">Man</option>  <option value ="01">Woman<option></select>, who is looking for a good time with <select name="seeks">  <option value ="10">a Man</option>  <option value ="01">a Woman</option>  <option value ="11">a Man or a Woman</option>  <option value ="00">some new pals</option></select>.</p>
