...
<div id="editprofile" style="display:none">
    ...
    <form action="update-profile.php" method="post">
        <p>My name is <?php echo($firstName." ".$lastName);?> and I am a 
            <select name="gender">  
                <option value ="10" <?php if($gender == "male") echo('selected="true"');?>>Man</option>  
                <option value ="01" <?php if($gender == "female") echo('selected="true"');?>>Woman<option>
            </select>, who is looking for a good time with 
            <select name="seeks"> 
                <option value ="00" <?php if($seeksmask == "00") echo('selected="true"');?>>some new pals</option> 
                <option value ="10" <?php if($seeksmask == "10") echo('selected="true"');?>>a Man</option>  
                <option value ="01" <?php if($seeksmask == "01") echo('selected="true"');?>>a Woman</option>  
                <option value ="11" <?php if($seeksmask == "11") echo('selected="true"');?>>a Man or a Woman</option>  
            </select>.
        </p>
