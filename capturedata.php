...
if (isset($_REQUEST['seeksmale']) and $_REQUEST['seeksmale'] == 'on')
    $seeksmale = 1;
else $seeksmale= 0;

if (isset($_REQUEST['seeksfemale']) and $_REQUEST['seeksfemale'] == 'on')
    $seeksfemale = 1;
else $seeksfemale= 0;
